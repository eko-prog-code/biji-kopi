            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="product-details text-left">
                  ...
                  <div class="quantity">
                    <a @click="saveKeranjang(productDetails.id, productDetails.name, productDetails.price, productDetails.galleries[0].photo)" href="#" class="primary-btn pd-cart">Tambah Keranjang</a>
                  </div>
                </div>
              </div>
            </div>
